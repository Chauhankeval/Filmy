...
const Header = () => {
    ...
    return (
        <div className='flex justify-between items-center border-b-2 border-gray-300'>
            <Link to='/'>
                <p className='text-2xl text-red-600 font-bold p-3'>
                    Filmy<span className='text-white'>City</span>
                </p>
            </Link>

            <div className='text-white flex mr-3 item-center text-lg cursor-pointer flex-wrap'>
